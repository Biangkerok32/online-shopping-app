...
<div id="reportTitle">
	<ul>
		<li style="font-size: 30px; color: violet">Monthly Orders Report</li>
...
<div id="res">
	<ul>
		<li># of Transactions: <?php echo $count; ?></li>
		<li>Overall price: <?php echo $priceTotal; ?></li>
	</ul>
</div>
